...
* parameter[input-ethnicity].part contains
    ...
    DETHNIC4 0..1 and
    DETHNIC5 0..1
* parameter[input-ethnicity].part[DETHNIC1].name = "DETHNIC1"
* parameter[input-ethnicity].part[DETHNIC2].name = "DETHNIC2"
* parameter[input-ethnicity].part[DETHNIC3].name = "DETHNIC3"
