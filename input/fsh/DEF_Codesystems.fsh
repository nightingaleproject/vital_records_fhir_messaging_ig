...
* #http://nchs.cdc.gov/vrdr_submission_void   "VRDR Void" "Indicates this is  void  of  a  VRDR  DeathCertificate Document (deprecated)"
* #http://nchs.cdc.gov/submission_void   "Void" "Indicates this is  void  of  a  prior submission"
