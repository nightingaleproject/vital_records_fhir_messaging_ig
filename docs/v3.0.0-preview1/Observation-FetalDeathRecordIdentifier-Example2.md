# FetalDeathRecordIdentifier-Example2 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **FetalDeathRecordIdentifier-Example2**

## Example Observation: FetalDeathRecordIdentifier-Example2
...
```json
{
  ...
  "id" : "FetalDeathRecordIdentifier-Example2",
  "meta" : {
    "profile" : [
