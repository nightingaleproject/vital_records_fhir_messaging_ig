# CodedCauseOfFetalDeathUpdateHeader-Example1 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CodedCauseOfFetalDeathUpdateHeader-Example1**

## Example MessageHeader: CodedCauseOfFetalDeathUpdateHeader-Example1

Profile: [Cause of Death Coding Update Header](StructureDefinition-VRM-CauseOfDeathCodingUpdateHeader.md)

**event**: [http://nchs.cdc.gov/fd_causeofdeath_coding_update](http://nchs.cdc.gov/fd_causeofdeath_coding_update)
