# UpdateMessage-Example1 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **UpdateMessage-Example1**

## Example Bundle: UpdateMessage-Example1

Profile: [Death Record Update Message](StructureDefinition-VRM-DeathRecordUpdateMessage.md)

Bundle UpdateMessage-Example1 of type message

-------

Entry 1 - fullUrl = http://www.example.org/fhir/Header/UpdateHeader-Example1
...
**event**:`http://nchs.cdc.gov/vrdr_submission_update`
> **destination**
