# ParametersLinkage-LiveBirthWithPendingCert - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ParametersLinkage-LiveBirthWithPendingCert**

## Example Parameters: ParametersLinkage-LiveBirthWithPendingCert
...
```json
{
  ...
  "id" : "ParametersLinkage-LiveBirthWithPendingCert",
  "meta" : {
    "profile" : [
  ...
  "parameter" : [
    {
      "name" : "notes",
      "valueString" : "Live Birth With Pending Certificate"
    },
    {
      "name" : "coded_outcome",
