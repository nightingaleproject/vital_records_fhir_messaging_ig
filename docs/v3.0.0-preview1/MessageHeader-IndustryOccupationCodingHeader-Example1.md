# IndustryOccupationCodingHeader-Example1 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **IndustryOccupationCodingHeader-Example1**

## Example MessageHeader: IndustryOccupationCodingHeader-Example1

Profile: [Industry Occupation Coding Header](StructureDefinition-VRM-IndustryOccupationCodingHeader.md)

**event**: [http://nchs.cdc.gov/vrdr_industryoccupation_coding](http://nchs.cdc.gov/vrdr_industryoccupation_coding)
