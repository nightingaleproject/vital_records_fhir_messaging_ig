# MaternalLinkageBundle-BirthPendingCert - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MaternalLinkageBundle-BirthPendingCert**

## Example Bundle: MaternalLinkageBundle-BirthPendingCert

Profile: [Maternal Linkage Content Bundle](StructureDefinition-VRM-maternal-linkage-content-bundle.md)

Bundle MaternalLinkageBundle-BirthPendingCert of type collection
...
{
  "resourceType" : "Bundle",
  "id" : "MaternalLinkageBundle-BirthPendingCert",
  "meta" : {
    "profile" : [
