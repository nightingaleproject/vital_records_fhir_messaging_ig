# BirthReportMessage-Example1 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **BirthReportMessage-Example1**

## Example Bundle: BirthReportMessage-Example1

Profile: [Birth Report Message](StructureDefinition-VRM-BirthReportMessage.md)

Bundle BirthReportMessage-Example1 of type message

-------

Entry 1 - fullUrl = http://www.example.org/fhir/Header/BirthReportHeader-Example1
...
**event**:`http://nchs.cdc.gov/birth_submission`
> **destination**
...
{
  "resourceType" : "Bundle",
  "id" : "BirthReportMessage-Example1",
  "meta" : {
    "profile" : [
      "http://cdc.gov/nchs/nvss/fhir/vital-records-messaging/StructureDefinition/VRM-BirthReportMessage"
    ]
  },
  "type" : "message",
  ...
  "entry" : [
    {
      "fullUrl" : "http://www.example.org/fhir/Header/BirthReportHeader-Example1",
      "resource" : {
