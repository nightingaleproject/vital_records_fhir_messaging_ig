# BirthRecordIdentifierChild-ExtensiveExample2 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **BirthRecordIdentifierChild-ExtensiveExample2**

## Example Observation: BirthRecordIdentifierChild-ExtensiveExample2
