# IndustryOccupationCodingMessage-Example1 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **IndustryOccupationCodingMessage-Example1**

## Example Bundle: IndustryOccupationCodingMessage-Example1

Profile: [Industry Occupation Coding Message](StructureDefinition-VRM-IndustryOccupationCodingMessage.md)

Bundle IndustryOccupationCodingMessage-Example1 of type message

-------

Entry 1 - fullUrl = http://www.example.org/fhir/Header/IndustryOccupationCodingHeader-Example1

Resource MessageHeader:

> 

Profile: [Industry Occupation Coding Header](StructureDefinition-VRM-IndustryOccupationCodingHeader.md)

**event**:`http://nchs.cdc.gov/vrdr_industryoccupation_coding`
> **destination**
  ...
  "entry" : [
    {
      ...
      "resource" : {
        ...
        "text" : {
          "status" : "generated",
          "div" : "<div xmlns=\"http://www.w3.org/1999/xhtml\"><a name=\"MessageHeader_IndustryOccupationCodingHeader-Example1\"> </a><p class=\"res-header-id\"><b>Generated Narrative: MessageHeader IndustryOccupationCodingHeader-Example1</b></p><a name=\"IndustryOccupationCodingHeader-Example1\"> </a><a name=\"hcIndustryOccupationCodingHeader-Example1\"> </a><div style=\"display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\"><p style=\"margin-bottom: 0px\"/><p style=\"margin-bottom: 0px\">Profile: <a href=\"StructureDefinition-VRM-IndustryOccupationCodingHeader.html\">Industry Occupation Coding Header</a></p></div><p><b>event</b>: <a href=\"http://nchs.cdc.gov/vrdr_industryoccupation_coding\">http://nchs.cdc.gov/vrdr_industryoccupation_coding</a></p><h3>Destinations</h3><table class=\"grid\"><tr><td style=\"display: none\">-</td><td><b>Endpoint</b></td></tr><tr><td style=\"display: none\">*</td><td><a href=\"https://sos.ny.gov/vitalrecords\">https://sos.ny.gov/vitalrecords</a></td></tr></table><h3>Sources</h3><table class=\"grid\"><tr><td style=\"display: none\">-</td><td><b>Endpoint</b></td></tr><tr><td style=\"display: none\">*</td><td><a href=\"http://nchs.cdc.gov/vrdr_submission\">http://nchs.cdc.gov/vrdr_submission</a></td></tr></table><h3>Responses</h3><table class=\"grid\"><tr><td style=\"display: none\">-</td><td><b>Identifier</b></td><td><b>Code</b></td></tr><tr><td style=\"display: none\">*</td><td>SubmissionHeader-Example1</td><td>OK</td></tr></table><p><b>focus</b>: </p><ul><li><a href=\"Bundle-BirthReportMessage-Example1.html#http-//www.example.org/fhir/Bundle/DummyBundle\">Bundle: type = collection</a></li><li><a href=\"Bundle-AcknowledgementMessage-Example1.html#http-//www.example.org/fhir/Parameters/Parameters-Example1\">Parameters: cert_no, jurisdiction_id, event_year, state_auxiliary_id, payload_version_id</a></li></ul></div>"
        },
