# CauseOfDeathCodingMessage-Example1 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CauseOfDeathCodingMessage-Example1**

## Example Bundle: CauseOfDeathCodingMessage-Example1

Profile: [Cause of Death Coding Message](StructureDefinition-VRM-CauseOfDeathCodingMessage.md)

Bundle CauseOfDeathCodingMessage-Example1 of type message

-------

Entry 1 - fullUrl = http://www.example.org/fhir/Header/CauseOfDeathCodingHeader-Example1
...
**event**:`http://nchs.cdc.gov/vrdr_causeofdeath_coding`
> **destination**
