# IndustryOccupationCodingUpdateMessage1 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **IndustryOccupationCodingUpdateMessage1**

## Example Bundle: IndustryOccupationCodingUpdateMessage1

Profile: [Industry Occupation Coding Update Message](StructureDefinition-VRM-IndustryOccupationCodingUpdateMessage.md)

Bundle IndustryOccupationCodingUpdateMessage1 of type message

-------

Entry 1 - fullUrl = http://www.example.org/fhir/Header/IndustryOccupationCodingUpdateHeader-Example1
...
**event**:`http://nchs.cdc.gov/vrdr_industryoccupation_coding_update`
> **destination**
...
{
  "resourceType" : "Bundle",
  "id" : "IndustryOccupationCodingUpdateMessage1",
  "meta" : {
    "profile" : [
      "http://cdc.gov/nchs/nvss/fhir/vital-records-messaging/StructureDefinition/VRM-IndustryOccupationCodingUpdateMessage"
    ]
  },
  "type" : "message",
  ...
  "entry" : [
    {
      "fullUrl" : "http://www.example.org/fhir/Header/IndustryOccupationCodingUpdateHeader-Example1",
      "resource" : {
        ...
        "text" : {
          "status" : "generated",
          "div" : "<div xmlns=\"http://www.w3.org/1999/xhtml\"><a name=\"MessageHeader_IndustryOccupationCodingUpdateHeader-Example1\"> </a><p class=\"res-header-id\"><b>Generated Narrative: MessageHeader IndustryOccupationCodingUpdateHeader-Example1</b></p><a name=\"IndustryOccupationCodingUpdateHeader-Example1\"> </a><a name=\"hcIndustryOccupationCodingUpdateHeader-Example1\"> </a><div style=\"display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\"><p style=\"margin-bottom: 0px\"/><p style=\"margin-bottom: 0px\">Profile: <a href=\"StructureDefinition-VRM-IndustryOccupationCodingUpdateHeader.html\">Industy Occupation Coding Update  Header</a></p></div><p><b>event</b>: <a href=\"http://nchs.cdc.gov/vrdr_industryoccupation_coding_update\">http://nchs.cdc.gov/vrdr_industryoccupation_coding_update</a></p><h3>Destinations</h3><table class=\"grid\"><tr><td style=\"display: none\">-</td><td><b>Endpoint</b></td></tr><tr><td style=\"display: none\">*</td><td><a href=\"https://sos.ny.gov/vitalrecords\">https://sos.ny.gov/vitalrecords</a></td></tr></table><h3>Sources</h3><table class=\"grid\"><tr><td style=\"display: none\">-</td><td><b>Endpoint</b></td></tr><tr><td style=\"display: none\">*</td><td><a href=\"http://nchs.cdc.gov/vrdr_submission\">http://nchs.cdc.gov/vrdr_submission</a></td></tr></table><h3>Responses</h3><table class=\"grid\"><tr><td style=\"display: none\">-</td><td><b>Identifier</b></td><td><b>Code</b></td></tr><tr><td style=\"display: none\">*</td><td>SubmissionHeader-Example1</td><td>OK</td></tr></table><p><b>focus</b>: </p><ul><li><a href=\"Bundle-BirthReportMessage-Example1.html#http-//www.example.org/fhir/Bundle/DummyBundle\">Bundle: type = collection</a></li><li><a href=\"Bundle-AcknowledgementMessage-Example1.html#http-//www.example.org/fhir/Parameters/Parameters-Example1\">Parameters: cert_no, jurisdiction_id, event_year, state_auxiliary_id, payload_version_id</a></li></ul></div>"
        },
