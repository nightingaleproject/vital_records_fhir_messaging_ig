# ParentalDemographicsCodingMessage-Example1 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ParentalDemographicsCodingMessage-Example1**

## Example Bundle: ParentalDemographicsCodingMessage-Example1

Profile: [Demographics Coding Message](StructureDefinition-VRM-DemographicsCodingMessage.md)

Bundle ParentalDemographicsCodingMessage-Example1 of type message

-------

Entry 1 - fullUrl = http://www.example.org/fhir/Header/ParentalDemographicsCodingHeader-Example1
...
**event**:`http://nchs.cdc.gov/birth_demographics_coding`
> **destination**
...
{
  "resourceType" : "Bundle",
  "id" : "ParentalDemographicsCodingMessage-Example1",
  "meta" : {
    "profile" : [
  ...
  "entry" : [
    {
      "fullUrl" : "http://www.example.org/fhir/Header/ParentalDemographicsCodingHeader-Example1",
      "resource" : {
