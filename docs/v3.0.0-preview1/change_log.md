# Change Log - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1
...
* Added support for [Maternal Linkage records for Mortality](maternallinkage.md)
* Corrected Display name for Birth Acknowledgement within [MessageHeader URI values](https://nightingaleproject.github.io/vital_records_fhir_messaging_ig/v3.0.0-preview1/ValueSet-VRM-AcknowledgementHeaderURI-vs.html)
...
* Added payload version parameter to [MessageParameters](StructureDefinition-VRM-MessageParameters.md) to support messages from all known versions of vital records IGs.
* Enhanced [AcknowledgementMessage](StructureDefinition-VRM-AcknowledgementMessage.md) to include optional content warnings.
...
* Added note regarding lack of support for [extraction error messages](message.md#message-extraction-failures) by NCHS API (November 2022)
