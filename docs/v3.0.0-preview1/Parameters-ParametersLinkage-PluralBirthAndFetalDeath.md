# ParametersLinkage-PluralBirthAndFetalDeath - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ParametersLinkage-PluralBirthAndFetalDeath**

## Example Parameters: ParametersLinkage-PluralBirthAndFetalDeath
