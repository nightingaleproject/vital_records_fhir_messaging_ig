# DemographicsCodingMessage-Example1 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DemographicsCodingMessage-Example1**

## Example Bundle: DemographicsCodingMessage-Example1

Profile: [Demographics Coding Message](StructureDefinition-VRM-DemographicsCodingMessage.md)

Bundle DemographicsCodingMessage-Example1 of type message

-------

Entry 1 - fullUrl = http://www.example.org/fhir/Header/DemographicsCodingHeader-Example1
...
**event**:`http://nchs.cdc.gov/vrdr_demographics_coding`
> **destination**
