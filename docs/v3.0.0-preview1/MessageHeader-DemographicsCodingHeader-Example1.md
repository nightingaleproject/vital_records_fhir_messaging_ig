# DemographicsCodingHeader-Example1 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DemographicsCodingHeader-Example1**

## Example MessageHeader: DemographicsCodingHeader-Example1

Profile: [Demographics Coding Header](StructureDefinition-VRM-DemographicsCodingHeader.md)

**event**: [http://nchs.cdc.gov/vrdr_demographics_coding](http://nchs.cdc.gov/vrdr_demographics_coding)
