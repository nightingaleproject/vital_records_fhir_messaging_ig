# MaternalLinkageBundle-PluralBirthAndFetalDeathWithCert - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MaternalLinkageBundle-PluralBirthAndFetalDeathWithCert**

## Example Bundle: MaternalLinkageBundle-PluralBirthAndFetalDeathWithCert

Profile: [Maternal Linkage Content Bundle](StructureDefinition-VRM-maternal-linkage-content-bundle.md)

Bundle MaternalLinkageBundle-PluralBirthAndFetalDeathWithCert of type collection

-------

Entry 1 - fullUrl = http://www.example.org/fhir/Parameter/ParametersLinkage-PluralBirthAndFetalDeath
...
Entry 4 - fullUrl = http://www.example.org/fhir/Observation/FetalDeathRecordIdentifier-Example1
...
Entry 5 - fullUrl = http://www.example.org/fhir/Observation/FetalDeathRecordIdentifierNoCert-Example3
...
{
  "resourceType" : "Bundle",
  "id" : "MaternalLinkageBundle-PluralBirthAndFetalDeathWithCert",
  "meta" : {
    "profile" : [
  ...
  "entry" : [
    {
      "fullUrl" : "http://www.example.org/fhir/Parameter/ParametersLinkage-PluralBirthAndFetalDeath",
      "resource" : {
        "resourceType" : "Parameters",
        "id" : "ParametersLinkage-PluralBirthAndFetalDeath",
        "meta" : {
          "profile" : [
        ...
        "parameter" : [
          {
            "name" : "notes",
            "valueString" : "PluralBirthAndFetalDeathWithCert"
          },
          {
            "name" : "coded_outcome",
    ...
    {
      "fullUrl" : "http://www.example.org/fhir/Observation/FetalDeathRecordIdentifier-Example1",
      "resource" : {
        "resourceType" : "Observation",
    ...
    {
      "fullUrl" : "http://www.example.org/fhir/Observation/FetalDeathRecordIdentifierNoCert-Example3",
      "resource" : {
        "resourceType" : "Observation",
        ...
        "text" : {
          "status" : "generated",
          "div" : "<div xmlns=\"http://www.w3.org/1999/xhtml\"><a name=\"Observation_FetalDeathRecordIdentifierNoCert-Example3\"> </a><p class=\"res-header-id\"><b>Generated Narrative: Observation FetalDeathRecordIdentifierNoCert-Example3</b></p><a name=\"FetalDeathRecordIdentifierNoCert-Example3\"> </a><a name=\"hcFetalDeathRecordIdentifierNoCert-Example3\"> </a><div style=\"display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\"><p style=\"margin-bottom: 0px\"/><p style=\"margin-bottom: 0px\">Profile: <a href=\"StructureDefinition-VRM-fetal-death-record-identifier.html\">Fetal Death Record Identifier</a></p></div><p><b>status</b>: Final</p><p><b>code</b>: <span title=\"Codes:{http://cdc.gov/nchs/nvss/fhir/vital-records-messaging/CodeSystem/VRM-observation-cs fetaldeathrecordidentifier}\">Fetal Death Record Identifier</span></p><blockquote><p><b>component</b></p><p><b>code</b>: <span title=\"Codes:\">availability</span></p><p><b>value</b>: <span title=\"Codes:{http://terminology.hl7.org/CodeSystem/v2-0136 N}\">No</span></p></blockquote><blockquote><p><b>component</b></p><p><b>code</b>: <span title=\"Codes:\">index</span></p><p><b>value</b>: 2</p></blockquote></div>"
        },
        "status" : "final",
        "code" : {
          "coding" : [
