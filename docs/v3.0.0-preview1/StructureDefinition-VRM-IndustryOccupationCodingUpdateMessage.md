# Industry Occupation Coding Update Message - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Industry Occupation Coding Update Message**

## Resource Profile: Industry Occupation Coding Update Message 

| | |
| :--- | :--- |
| *Official URL*:http://cdc.gov/nchs/nvss/fhir/vital-records-messaging/StructureDefinition/VRM-IndustryOccupationCodingUpdateMessage | *Version*:3.0.0-Preview1 |
| Draft as of 2025-11-25 | *Computable Name*:IndustryOccupationCodingUpdateMessage |
...
* Examples for this Profile: [Bundle/IndustryOccupationCodingUpdateMessage1](Bundle-IndustryOccupationCodingUpdateMessage1.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/vital-records-fhir-messaging|current/StructureDefinition/VRM-IndustryOccupationCodingUpdateMessage)
...
Other representations of profile: [CSV](StructureDefinition-VRM-IndustryOccupationCodingUpdateMessage.csv), [Excel](StructureDefinition-VRM-IndustryOccupationCodingUpdateMessage.xlsx), [Schematron](StructureDefinition-VRM-IndustryOccupationCodingUpdateMessage.sch) 
...
```json
{
  ...
  "url" : "http://cdc.gov/nchs/nvss/fhir/vital-records-messaging/StructureDefinition/VRM-IndustryOccupationCodingUpdateMessage",
  "version" : "3.0.0-Preview1",
  "name" : "IndustryOccupationCodingUpdateMessage",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "path" : "Bundle.entry",
        "sliceName" : "header",
        "short" : "Industry Occupation Coding Update Header",
        "definition" : "Industry Occupation Coding Update Header",
        "min" : 1,
        "max" : "1",
        "mustSupport" : true
      },
