# DemographicsCodingUpdateMessage1 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DemographicsCodingUpdateMessage1**

## Example Bundle: DemographicsCodingUpdateMessage1

Profile: [Demographics Coding Update Message](StructureDefinition-VRM-DemographicsCodingUpdateMessage.md)

Bundle DemographicsCodingUpdateMessage1 of type message

-------

Entry 1 - fullUrl = http://www.example.org/fhir/Header/DemographicsCodingUpdateHeader-Example1
...
**event**:`http://nchs.cdc.gov/vrdr_demographics_coding_update`
> **destination**
...
{
  "resourceType" : "Bundle",
  "id" : "DemographicsCodingUpdateMessage1",
  "meta" : {
    "profile" : [
  ...
  "entry" : [
    {
      "fullUrl" : "http://www.example.org/fhir/Header/DemographicsCodingUpdateHeader-Example1",
      "resource" : {
