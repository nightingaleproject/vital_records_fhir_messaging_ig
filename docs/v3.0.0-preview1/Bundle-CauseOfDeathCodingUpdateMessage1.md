# CauseOfDeathCodingUpdateMessage1 - Vital Records FHIR Messaging (VRFM) IG v3.0.0-Preview1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CauseOfDeathCodingUpdateMessage1**

## Example Bundle: CauseOfDeathCodingUpdateMessage1

Profile: [Cause Of Death Coding Update Message](StructureDefinition-VRM-CauseOfDeathCodingUpdateMessage.md)

Bundle CauseOfDeathCodingUpdateMessage1 of type message

-------

Entry 1 - fullUrl = http://www.example.org/fhir/Header/CauseOfDeathCodingUpdateHeader-Example1
...
**event**:`http://nchs.cdc.gov/vrdr_causeofdeath_coding_update`
> **destination**
...
{
  "resourceType" : "Bundle",
  "id" : "CauseOfDeathCodingUpdateMessage1",
  "meta" : {
    "profile" : [
      "http://cdc.gov/nchs/nvss/fhir/vital-records-messaging/StructureDefinition/VRM-CauseOfDeathCodingUpdateMessage"
    ]
  },
  "type" : "message",
  ...
  "entry" : [
    {
      "fullUrl" : "http://www.example.org/fhir/Header/CauseOfDeathCodingUpdateHeader-Example1",
      "resource" : {
